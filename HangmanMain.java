 ...
 *   
 *   Based on a program by Stuart Reges
 */
...
public class HangmanMain  
{
     ...
     */
    private static void setGameParameters(HangmanManager hangman, Scanner keyboard) 
    {
        if (hangman == null) 
        {
            throw new IllegalArgumentException("The HangmanManager " + "may not be null.");
        }
    ...
    private static HangmanDifficulty getDifficulty(Scanner keyboard)
    {
        if (keyboard== null) 
        {
            throw new IllegalArgumentException("The Scanner object " + "may not be null.");
        }
    ...
    private static Set<String> getDictionary()
    {
        ...
        catch(FileNotFoundException e)
        {
            ...
            System.out.println("Be sure the dictionary file is in " + "that directory");
